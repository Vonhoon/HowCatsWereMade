...
public class CarnivoreBlock : MonoBehaviour
{
    ...
    private void OnTriggerStay2D(Collider2D other)
    {
        if (other.CompareTag("PlayerBlock"))
        {
            ...
            {                
                other.GetComponent<PlayerBlock>().player.GetComponent<Player>().carnivore = true;
                other.GetComponent<PlayerBlock>().player.gameObject.tag = "Predator";
                other.GetComponent<PlayerBlock>().player.gameObject.layer = 19;
            ...
            if (other.GetComponent<DragScript>().dragging)
            {
                ...
                other.GetComponent<PlayerBlock>().player.GetComponent<Player>().carnivore = false;
                other.GetComponent<PlayerBlock>().player.gameObject.tag = other.GetComponent<PlayerBlock>().player.GetComponent<Player>().originalTag;
                other.GetComponent<PlayerBlock>().player.gameObject.layer = 12;
                EnableLine();
            }
